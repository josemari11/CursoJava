/*3 Crear el programa, utilizando la técnica de programación estructurada, para un determinado
...
● leerPrecio: Qué lee un precio y valida que sea positivo.
● calcularDescuento: Que recibe un precio y devuelve el descuento.
● CalcularPrecioTotal: Que recibe un precio y y el descuento y devuelve el precio final.*/
package MetodosDiciembreClase.Ejer3;
...
public class ImporteTienda {
	...
	final int TIPO_DESCUENTO_SUP=60;
	//porcentajes de descuento
	final int DESCUENTO_NORMAL=6;
	final int DESCUENTO_SUPER=10;
	//totales
	double descuento;
	double total;
